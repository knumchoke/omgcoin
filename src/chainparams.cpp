...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "OMGCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(hashGenesisBlock == uint256("0x000007cb18071a11816e038dcb04864e13a97c043863b1ef5854289209ec6620"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("omgcoin.test", "test.omgcoin.org"));

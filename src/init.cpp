...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: omgcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: omgcoind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. OMGCoin is probably already running."), strDataDir.c_str()));

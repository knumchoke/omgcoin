    ...
    prevBlocks(0)
{
    ...
    {
        setWindowTitle(tr("OMGCoin") + " - " + tr("") + " " + tr("[testnet]"));
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send OMGCoin"), this);
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive OMGCoin"), this);
    ...
    if (!fIsTestnet)
        ...
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About OMGCoin"), this);
    aboutAction->setStatusTip(tr("Show information about OMGCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for OMGCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OMGCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OMGCoin addresses"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    {
        trayIcon->setToolTip(tr("OMGCoin client") + " " + tr("[testnet]"));
...
{
    QString strTitle = tr("OMGCoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid OMGCoin address or malformed URI parameters."),
